    ...
    public function sendmail_ordersuccess($order_code)
    {
        ...
        if(App::getLocale() == 'en'){
            ...
            $details = [
                ...
                'Sub_Content_Top' => 'Trong 72 giờ tới, chúng tôi sẽ kiểm tra tình trạng hiện có của dòng xe '.$model_name. ' và đồng thời xác nhận thông tin cá nhân của bạn. Khi đơn hàng đủ điều kiện thanh toán, chúng tôi sẽ thông báo và hướng dẫn cách đặt cọc qua email.Để theo dõi đơn hàng, vào Trang Chủ, bấm vào nút "="  , sau đó chọn "Theo Dõi Đơn Hàng" và nhập Mã Đơn Hàng',
                'Model Name' => $model_name,
                'Order Price' => $order_price_format,
                'Deposit' => $deposit_format,
                'Shipping' => 'Miễn Phí',
