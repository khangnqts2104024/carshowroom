            ...
            <form action="" method="">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control formRound" name="provinces" id="provinces">
                        <option id="SelectYourProVince" value="{{__('Select Your Province/City')}}">{{__('Select Your Province/City')}}</option>
                ...
                <div>
                        ...
                        <input type="text" name="allFees" value="" id="allFees">
                        <input type="text" name="costEstimated" value="" id="costEstimated">
                    ...
                    <p class="mt-5">{{__('CostEstimate.The above table is for reference only. Please contact the nearest Showroom/Dealer for the most accurate quotation.')}}</p>
